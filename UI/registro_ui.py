...
def guardar_cliente_desde_dialogo(e, txt_nombre, txt_contacto, txt_direccion, callback_actualizar_tabla):
    """Guarda un cliente desde el diálogo modal."""
    errores = validar_campos(txt_nombre.value.strip(),
...
def crear_dialogo_agregar_cliente(e, callback_actualizar_tabla):
    ...
    txt_direccion = crear_campo_texto(
        'Direccion', 'Ej: Direccion 1234 calle 12')
        ...
        actions=[
            ft.TextButton(
                ...
                on_click=lambda e: guardar_cliente_desde_dialogo(
                    e, txt_nombre, txt_contacto, txt_direccion, callback_actualizar_tabla
                )
            ),
            ft.TextButton(
                "Cancelar",
