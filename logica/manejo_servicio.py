...
class ManejoServicio:
    ...
    def __init__(self):
        ...
        self.api_url = f"{API_BASE_URL}services/"
    ...
    def guardar_servicio(self, descripcion, precio):
        ...
        datos_servicio = {"description": descripcion, "price": precio}
        try:
    ...
    def editar_servicio(self, servicio_id, descripcion, precio):
        ...
        try:
            ...
            print("Tiempo de espera agotado al editar el servicio en la API.")
            return None
        except requests.exceptions.HTTPError as http_err:
            print(f"Error HTTP al editar el servicio: {http_err}")
            try:
                error_details = http_err.response.json()
                print("--- Detalles del error de validación de la API ---")
                print(json.dumps(error_details, indent=2))
            ...
            print(f"Error al editar el serviciooo: {e}")
            return None
